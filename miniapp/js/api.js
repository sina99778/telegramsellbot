...
const API = (() => {
    ...
    return {
        ...
        updateAdminPlanName:(id, name) => request('POST', `/admin/plans/${encodeURIComponent(id)}/name`, { name }),
        ...
        updateAdminServerSubScheme:(id, scheme) => request('POST', `/admin/servers/${encodeURIComponent(id)}/sub-scheme`, { scheme }),
