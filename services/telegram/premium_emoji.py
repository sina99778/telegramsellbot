...
# Catalogue of every emoji actually used in the bot's user-facing text.
# Generated by scanning core/texts.py + apps/bot/handlers/** + keyboards/**
# (regenerate with tmp_scan/emoji_scan to keep this in sync). The semantic
# keys here are stable — don't rename them without a migration of saved
# operator overrides.
#
# Order is roughly "most-used first" so the admin's paste-list prompt
# shows the visually-important emojis at the top.
